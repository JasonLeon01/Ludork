...
require_file "$PROJECT_ROOT/tools/editor_runtime/build_standalone.sh"
...
cp "$PROJECT_ROOT/tools/editor_runtime/common.sh" "$RESOURCES_DIR/tools/common.sh"
cp "$PROJECT_ROOT/tools/editor_runtime/build_cpp.sh" "$RESOURCES_DIR/tools/build_cpp.sh"
cp "$PROJECT_ROOT/tools/editor_runtime/build_standalone.sh" "$RESOURCES_DIR/tools/build_standalone.sh"
