...
| --- | --- | --- | --- | --- | --- |
| LuaSF | v3.1.0.5-ME-OH-2in1-support | 所有工程模板与 UI preview host 中的 SFML 绑定 | MIT | `Licenses/LuaSF/LICENSE.txt` | [JasonLeon01/LuaSF-AutoGenerator](https://github.com/JasonLeon01/LuaSF-AutoGenerator) |
