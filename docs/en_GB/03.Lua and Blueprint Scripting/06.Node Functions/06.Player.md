...
Attribute helpers prefer the generated Player attributes. Numeric setters write Base values. The Heal, Damage and Add-stat nodes apply Instant Effects. The State nodes are in [GlobalFunctions.Gameplay](<09.Gameplay.md>).
