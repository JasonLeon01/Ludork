...
On Android and iOS, returning from the background in the same process resumes the current scene and Lua state without rerunning Entry or catching up on background time; see the [SceneBase lifecycle](<../08.Global and Core Modules/02.Core Modules/02.GlobalCore/06.Scenes and System.md#scenebase>).
