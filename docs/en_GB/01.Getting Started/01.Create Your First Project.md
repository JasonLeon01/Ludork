...
4. Watch the Console for preparation and runtime output. Play in an **Individual Window** keeps the map visible and disables project editing by default. Enable [Live Debug](<../02.Editor User Guide/08.Run Debug and Package.md#live-debug>) before Play to edit the running map from the editor.
