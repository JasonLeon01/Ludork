...
| API | Purpose |
|---|---|
| `Class.isInstance(value, target)` | Test an instance against its complete MRO. |
...
- [Core Modules API Reference](<../03.Lua and Blueprint Scripting/07.API Reference/04.Core Modules/01.CoreSystem.md>)
