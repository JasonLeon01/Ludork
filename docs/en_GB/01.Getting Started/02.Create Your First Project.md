...
Standalone projects use the supplied native runtime. Choose C++ Source at project creation when native services, bindings, an iOS target, a HarmonyOS target or an Android target are required. FFmpeg is not needed unless the game plays video.
