...
Keep source images beneath `Assets/Animations` or another intended asset folder. Non-empty image and sound entries store complete `/Game/Assets/...` paths. Preview timing before relying on an animation's total or visual duration.
