...
Controller code, nested-instance ownership and asset validation are covered by [Declarative UI](<../03.Lua and Blueprint Scripting/05.Declarative UI/01.Authoring Workflow.md>).
