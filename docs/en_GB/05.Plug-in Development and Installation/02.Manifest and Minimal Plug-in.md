...
Adjust the reference to match the source layout. The project is for IDE analysis only. Every source needed at runtime must remain in the imported directory and use host-provided dependencies.
