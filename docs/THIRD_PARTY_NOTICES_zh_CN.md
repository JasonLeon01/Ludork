...
| --- | --- | --- | --- | --- | --- |
| LuaSF | v3.1.0.7 | 所有工程模板与 UI preview host 中的 SFML 绑定 | MIT | `Licenses/LuaSF/LICENSE.txt` | [JasonLeon01/LuaSF-AutoGenerator](https://github.com/JasonLeon01/LuaSF-AutoGenerator) |
...
| --- | --- | --- | --- | --- | --- |
| Gradle Wrapper | 启动脚本与 JAR 快照见其来源说明；下载 Gradle 9.5.0 | 编辑器 C++ Source 模板中的 Android 构建工具，位于 `Engine/PlatformHosts/Android` | Apache License 2.0 | 各 C++ Source 模板内的 `Engine/PlatformHosts/Android/gradle/wrapper/LICENSE.txt` 与 `NOTICE.md` | [Gradle](https://github.com/gradle/gradle) |
