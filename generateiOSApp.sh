...
cp "${TEMPLATE_DIR}/LudorkSceneDelegate.h" "${SOURCE_SUBDIR}/"
cp "${TEMPLATE_DIR}/LudorkSceneDelegate.m" "${SOURCE_SUBDIR}/"
cp "${TEMPLATE_DIR}/SFAppDelegate+LudorkScene.m" "${SOURCE_SUBDIR}/"
