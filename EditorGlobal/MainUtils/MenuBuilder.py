...
class MenuBuilderMixin:
    def _setTopMenu(self) -> None:
        ...
        self._actDatabaseSystemConfig.setShortcut(QtGui.QKeySequence("F5"))
        self._actAnimationOverview.triggered.connect(self._onAnimationOverview)
        self._actAnimationOverview.setShortcut(QtGui.QKeySequence("F6"))
        self._actDatabaseTilesetsData.triggered.connect(self._onDatabaseTilesetsData)
        self._actDatabaseTilesetsData.setShortcut(QtGui.QKeySequence("F7"))
        self._actDatabaseCommonFunctions.triggered.connect(self._onDatabaseCommonFunctions)
        self._actDatabaseCommonFunctions.setShortcut(QtGui.QKeySequence("F8"))
        _dbMenu.addAction(self._actDatabaseSystemConfig)
        _dbMenu.addAction(self._actAnimationOverview)
