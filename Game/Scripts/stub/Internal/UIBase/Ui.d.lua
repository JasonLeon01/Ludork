---@meta Internal.UIBase.Ui

---@class Internal.UIBase.Ui.Module
local Ui = {}
...
---@generic T: table
---@param viewClass  Class.ClassType<Internal.UIBase.UiView> | Internal.UIBase.UiView
---@param definition T
...
---@class Internal.UIBase.Ui.Window: Engine.Canvas
---@field ui                    Internal.UIBase.UiView
---@field _controller           Internal.UIBase.UiController
---@field _controllerDispose    function | nil
---@field _windowBindingDispose function | nil
---@field _windowBinding        Internal.UIBase.UiWindow
...
---@return Internal.UIBase.Ui.Window
...
---@return Class.ClassType<Internal.UIBase.Ui.Window> & Internal.UIBase.Ui.Window
