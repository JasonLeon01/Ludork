---@meta Internal.UIBase.LazyWindow

--- Owns one window, constructed and mounted by its factory on first use.
---@class Internal.UIBase.LazyWindow<T: Internal.UIBase.Ui.Window>
...
---@generic T: Internal.UIBase.Ui.Window
---@param factory fun(): T
---@return Internal.UIBase.LazyWindow<T>
