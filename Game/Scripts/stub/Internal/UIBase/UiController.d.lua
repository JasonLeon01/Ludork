---@meta Internal.UIBase.UiController

---@class Internal.UIBase.UiController
---@field windowOptions         Internal.UIBase.Ui.WindowOptions | nil
---@field _transition           Internal.UIBase.WindowTransition
---@field host                  Internal.UIBase.Ui.Window | nil
---@field _hostDispose          function | nil
---@field assetKey              string
---@field viewClass             Class.ClassType<Internal.UIBase.UiView> | nil
...
---@field _observer             Internal.UIBase.UiObserver<Internal.UIBase.UiController>
---@field _observerDispose      function
---@field _callbackTarget       Internal.UIBase.UiController[] | nil
...
---@param model any
---@param ui    Internal.UIBase.UiView | nil
...
---@param unregister fun(controller: Internal.UIBase.UiController)
