...
---@field private _sourcePositions sf.Vector2i[]
...
---@brief Return the source Actor and ancestor map cells retained after the snapshot is captured.
---@return sf.Vector2i[]
function ActorPixelShatterEffect:getSourcePositions() end
