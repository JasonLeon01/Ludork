...
--- Cancel pending goals, active movement and the route preview for this controller.
function MapClickAutoPath:cancel() end

---@param gameMap GameMap
function MapClickAutoPath.CancelForMap(gameMap) end
