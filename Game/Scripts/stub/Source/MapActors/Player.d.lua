---@meta Source.MapActors.Player
---@class Source.MapActors.Player.SaveData
...
---@class Source.MapActors.Player.Player: Engine.Character, Source.Battler.Battler
...
---@field new                       fun(texture?: sf.Texture, tag?: string): Source.MapActors.Player.Player
local Player = {}
...
---
---@return Source.MapActors.Player.SaveData
