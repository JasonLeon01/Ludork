---@meta Source.LiveDebug

---@class Source.LiveDebug.TileEdit
---@field x      integer
---@field y      integer
---@field tileId integer | string | lightuserdata | nil

---@class Source.LiveDebug.TileChange
---@field layer    string
---@field x        integer
---@field y        integer
...
---@field visual          Source.LiveDebug.Visual

---@class Source.LiveDebug.Info
---@field actorId string
---@field values  table<string, any>
---@field schema  table<string, any>

---@class Source.LiveDebug.Response
...
---@field map         Source.LiveDebug.Map | nil
---@field actors      table<string, Source.LiveDebug.Actor[]> | nil
---@field variables   table<string, table<string, any>> | nil
---@field info        Source.LiveDebug.Info | nil
---@field tileUpdated boolean | nil
---@field tileChanges Source.LiveDebug.TileChange[] | nil

---@class Source.LiveDebug.Map
---@field mapName           string
---@field width             integer
---@field height            integer
---@field layerOrder        string[]
---@field layers            table<string, Source.SceneComponents.MapLayerData>
---@field actors            table<string, Source.LiveDebug.Actor[]>
---@field BPClassVarChanged table<string, table<string, any>>

---@class Source.LiveDebug.View
