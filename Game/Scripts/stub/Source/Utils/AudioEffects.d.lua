---@meta Source.Utils.AudioEffects

---@alias Source.Utils.AudioEffects.Attacher fun(source: sf.SoundSource, control: GlobalCore.AudioEffectControl, sampleRate: integer)
...
---@param name string
---@return Source.Utils.AudioEffects.Attacher | nil
