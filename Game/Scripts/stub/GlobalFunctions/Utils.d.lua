---@meta GlobalFunctions.Utils

local Utils = {}

---@alias GlobalFunctions.Utils.NodeReference<T> GlobalFunctions.Utils.AttrRef<T> | GlobalFunctions.Utils.LocalRef<T>

---@class GlobalFunctions.Utils.AttrRef<T>
---@field obj  table
---@field name string
local AttrRef = {}
...
---@class GlobalFunctions.Utils.LocalRef<T>
...
---@param name    string
---@param default T | nil
---@return GlobalFunctions.Utils.LocalRef<T>
...
--- - @param value The value to set.
---@param valueName string
---@param value     Source.GameInstance.RecordValue | GlobalFunctions.Utils.NodeReference<Source.GameInstance.RecordValue>
...
---@return GlobalFunctions.Utils.AttrRef<T>
