---@meta GlobalFunctions.Math

---@alias GlobalFunctions.Math.Vector2Value sf.Vector2f | sf.Vector2i | sf.Vector2u
---@alias GlobalFunctions.Math.Vector3Value sf.Vector3f | sf.Vector3i
---@alias GlobalFunctions.Math.VectorValue GlobalFunctions.Math.Vector2Value | GlobalFunctions.Math.Vector3Value
...
---@param v1 GlobalFunctions.Math.Vector2Value
---@param v2 GlobalFunctions.Math.Vector2Value
---@return number
...
---@param v GlobalFunctions.Math.Vector2Value
---@return number
function Math.Vector2LengthSquared(v) end

---@param v GlobalFunctions.Math.Vector3Value
---@return number
...
---@generic T: GlobalFunctions.Math.Vector2Value
---@param v T
---@return T
