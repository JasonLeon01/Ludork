...
local Snapshot = require("Internal.LiveDebug.Snapshot")
local TileUpdates = require("Internal.LiveDebug.Tiles")
local Values = require("Internal.LiveDebug.Values")
...
---@return Internal.LiveDebug.View | nil, string, GameMap | nil, string
...
---@return Internal.LiveDebug.View | nil
...
---@param view Internal.LiveDebug.View | nil
---@return Internal.LiveDebug.Response
...
---@param request  Internal.LiveDebug.Request
---@param view     Internal.LiveDebug.View | nil
