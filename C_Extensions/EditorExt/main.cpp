...
PYBIND11_MODULE(EditorExt, m) {
    ...
    m.def("C_RenderTilemapRGBA", &C_RenderTilemapRGBA, py::arg("tilesetRgba"), py::arg("tilesetW"), py::arg("tilesetH"),
          py::arg("tilesetStride"), py::arg("tiles"), py::arg("mapW"), py::arg("mapH"), py::arg("tileSize"));
}
