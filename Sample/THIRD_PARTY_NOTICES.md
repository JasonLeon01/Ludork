...
| --- | --- | --- | --- | --- | --- |
| LuaSF | 3.1.0.4-ME-OH | SFML bindings in the Sample and all project templates | MIT | `Licenses/LuaSF/LICENSE.txt` | [JasonLeon01/LuaSF-AutoGenerator](https://github.com/JasonLeon01/LuaSF-AutoGenerator) |
