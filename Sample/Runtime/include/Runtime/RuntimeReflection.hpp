...
public:
    ...
    RuntimeValue::Array mro(const RuntimeValue& classType) const;
    std::vector<std::string> keys(
        const RuntimeValue& value,
        RuntimeLookupMode mode = RuntimeLookupMode::Visible) const;
    RuntimeValue get(const RuntimeValue& value, const std::string& name,
                     RuntimeLookupMode mode = RuntimeLookupMode::Visible) const;
    void set(const RuntimeValue& value, const std::string& name,
             const RuntimeValue& member) const;
    std::string toString(const RuntimeValue& value) const;
    RuntimeValue construct(const RuntimeValue& classType,
                           const RuntimeValue::Array& arguments = {}) const;
    RuntimeValue::Array call(const RuntimeValue& receiver,
