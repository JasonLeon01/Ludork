...
`Sample/Engine/Source` contains the C++20 Engine, GlobalCore and GlobalFunctions modules. Shared values, Lua-session services, binding infrastructure and Blueprint execution live in the `Sample/Engine/Runtime` library.
