...
float getCompressedAnimationVisualDuration(
    const AnimSprite::AnimationData& animationData) {
...
AnimSprite::AnimSprite(const AnimSprite::AnimationData& animationData)
    : sf::Sprite(placeholderTexture()) {
    setData(animationData);
}

void AnimSprite::setData(const AnimSprite::AnimationData& animationData) {
