...
from Engine.Gameplay import SceneBase, Actor, Character


class Scene(SceneBase):
    def onCreate(self):
        self.actors = [
            Character(Manager.loadCharacter("actors/020-Braver10.png")),
            Character(Manager.loadCharacter("actors/classic-cha-braver01.png")),
        ]
        for i, actor in enumerate(self.actors):
            actor.setAnimatable(True, True)

        self.actors[0].setPosition((96, 160))
        self.actors[0].setMoveSet([(Vector2f(384, 160), seconds(2)), (Vector2f(96, 160), seconds(2))])
