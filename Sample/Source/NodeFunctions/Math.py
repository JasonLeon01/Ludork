...
@Meta(DisplayName='LOC("IS_NEAR_ZERO")', DisplayDesc='LOC("IS_NEAR_ZERO_DESC")')
...
@Meta(DisplayName='LOC("AS_DEGREES")', DisplayDesc='LOC("AS_DEGREES_DESC")')
@ReturnType(value=float)
def AsDegrees(angle: Angle) -> float:
    return angle.asDegrees()


@Meta(DisplayName='LOC("AS_RADIANS")', DisplayDesc='LOC("AS_RADIANS_DESC")')
@ReturnType(value=float)
