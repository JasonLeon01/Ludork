...
---@field controllerClass    Source.Windows.WindowCommand.Controller
---@field _commandController Source.Windows.WindowCommand.Controller
---@field new                fun(rect: sf.IntRect, commands?: Source.UI.Parts.Shared.CommandRowModel[], rectWidth?: integer, rectHeight?: integer, windowSkin?: sf.Image, repeated?: boolean, columns?: integer, externalView?: table): Source.Windows.WindowCommand
local WindowCommand = {}
...
---@param commands     Source.UI.Parts.Shared.CommandRowModel[] | nil
