...
--- @brief Remove a state from the player.
---
--- - @param stateID State identifier.
---@param stateID string
function Player.RemovePlayerState(stateID) end

--- @brief Reduce a state stack count on the player and remove it at zero.
---
--- - @param stateID State identifier.
--- - @param stacks Stack count to reduce.
---@param stateID string
---@param stacks  integer
function Player.ReducePlayerState(stateID, stacks) end
