...
---@class Source.Scenes.SceneTitle.Controller: Source.UIBase.UiController
---@field ui             Source.UI.Title
---@field model          Source.Scenes.SceneTitle
---@field refreshEvents  string[]
---@field _commandModels Source.UIBase.CommandRow.Controller.Model[]
