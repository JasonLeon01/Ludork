...
- Blueprint function modules under `Scripts/GlobalFunctions` must not call `require` at module scope, including for native modules. Use the repository's GlobalFunctions check before committing and through PR validation.
